 ...
 * Ball object.
 */
public class Ball extends com.orizon.shashank_ayush.barcontra.breakout.TexturedAlignedRect {
    private static final String TAG = com.orizon.shashank_ayush.barcontra.breakout.BreakoutActivity.TAG;
